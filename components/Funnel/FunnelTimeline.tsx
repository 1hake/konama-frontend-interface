...
export function FunnelTimeline({
  ...
  return (
    <div className="bg-white/[0.03] backdrop-blur-xl rounded-2xl border border-white/[0.08] p-5 shadow-lg">
      <h3 className="text-xs font-semibold text-white/50 uppercase tracking-wider mb-4 px-1">Pipeline</h3>
          ...
          {steps.map((step, index) => {
            ...
            return (
              ...
              >
                {/* Step Circle */}
                <div
                  className={`w-10 h-10 rounded-full flex items-center justify-center relative z-10 transition-all duration-300 ease-out ${isCurrent
                ...
                <div className="mt-3 text-center">
                  <div className={`text-sm font-semibold transition-colors ${isCurrent ? 'text-blue-400' : 'text-white/50'
                    }`}>
                    {index + 1}
                  </div>
