...
export function ImageRefinementPanel({
    ...
    const updateRefinement = (
        imageId: string,
        updates: Partial<FunnelRefinement>
    ) => {
        setRefinements(prev => {
        ...
        return (
            <div className="bg-white/[0.03] backdrop-blur-xl rounded-2xl border border-white/[0.08] p-12 text-center shadow-lg">
                <p className="text-white/40 font-medium">
                    Select images to refine their parameters
                </p>
            </div>
        );
    }
            ...
            <div className="space-y-4 pb-6 border-b border-white/[0.08]">
                ...
                <div>
                    <div className="flex items-center justify-between mb-2.5">
                        <label className="block text-sm text-white/50 font-medium">
                            Prompt Override
                        </label>
                        <button
                            onClick={() => {
                ...
                <div>
                    <label className="block text-sm text-white/50 mb-2.5 font-medium">
