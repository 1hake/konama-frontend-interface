...
export default function Home() {
    ...
    const { workflows: availableWorkflows, refreshWorkflows } = useWorkflows();
    ...
    useEffect(() => {
        ...
        if (shouldBeFunnelMode !== isFunnelMode) {
            ...
            console.log(
                `Auto-switched to ${shouldBeFunnelMode ? 'funnel' : 'normal'} mode:`,
    ...
    const getImageUrl = (image: GeneratedImage) => {
        ...
        if (image.filename.startsWith('mock_')) {
            ...
            const seed = Math.abs(
                image.filename.split('_')[1]?.charCodeAt(0) || Date.now()
            );
            ...
            if (!funnel) {
                ...
                try {
                    ...
                    const stepRefinements =
                        refinementState.imageRefinements.length > 0
                    ...
                    await createNextStep(
                        ...
                        refinementState.technicalFields ||
        ...
        <AuthenticatedLayout>
            <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-black pb-[400px]">
                                    ...
                                    <div className="glass rounded-3xl shadow-2xl p-12 text-center border border-white/10 min-h-[500px] flex items-center justify-center">
                                        <div className="max-w-md">
                                            ...
                                            <p className="text-white/60 mb-6">
                                                Use the prompt builder below to
                                                create your first funnel. Select
                                                multiple workflows to generate
                                                diverse results.
                                            </p>
                                        </div>
                                    </div>
                ...
                <ImageGenerationForm
                    ...
                    isGenerating={
                        isFunnelMode ? isFunnelGenerating : isGenerating
                    }
